                            ...
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                      ...
                                      <th><a href="index.php?column=first_name&order=<?php echo $asc_or_desc; ?>">First Name<i class="fas fa-sort<?php echo $column == 'first_name' ? '-' . $up_or_down : ''; ?>"></i></a></th>
                                      <th><a href="index.php?column=last_name&order=<?php echo $asc_or_desc; ?>">Last Name<i class="fas fa-sort<?php echo $column == 'last_name' ? '-' . $up_or_down : ''; ?>"></i></a></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php 
